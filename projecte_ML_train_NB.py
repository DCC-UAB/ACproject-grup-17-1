...
#     print("\nTraining and evaluating model with Naive Bayes...\n")
#     main()
#     print("\n\nDone!!!")
...
def main():
    ...
    twitter_model.train_model(True)
